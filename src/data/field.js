...
draft quote for review                     ← a person still signs it`,
...

  {
    ...
    body: [
      ...
      },
      {
        ...
        text: 'The intermediate representation and pipeline are [Wheatear](/builds/wheatear), which is public. The engagement is the migration; the tool is not the deliverable.',
      },
    ],
    learn: [
...

  {
    ...
    learn: [
      ...
      { label: 'OpenLCM — the memory model', href: '/docs/openlcm/memory-model' },
    ],
